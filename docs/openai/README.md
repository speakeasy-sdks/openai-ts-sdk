...
sdk.openAI.createFineTune({
  ...
  classificationNClasses: 976460,
  classificationPositiveClass: "vero",
  computeClassificationMetrics: false,
  learningRateMultiplier: 4686.51,
  model: "praesentium",
  nEpochs: 976762,
  promptLossWeight: 557.14,
  suffix: "omnis",
